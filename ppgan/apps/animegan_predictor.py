...
class AnimeGANPredictor(BasePredictor):
    def __init__(self,
        ...
        if weight_path is None:
            ...
            # vox_cpk_weight_url = 'https://paddlegan.bj.bcebos.com/models/animeganv2_Paprika.pdparams'
    ...
    def anime_image_only(self, image):
        ...
        if self.use_adjust_brightness:
            ...
            anime = anime.astype('uint8')
        return cv2.cvtColor(anime, cv2.COLOR_RGB2BGR)
