...
class Photo2CartoonPredictor(BasePredictor):
    ...
    def run(self, image_path):
        ...
        cartoon_save_path = os.path.join(self.output_path, 'p2c_cartoon2425.png')
    ...
    def cartoon_only(self, image_path):
        image = Image.open(image_path)
        ...
        cv2.imwrite('/home/kohou/cvgames/interest/contest/baidu/AIstudio/AICreation/1th/data/images/li/liyunlongcartoon.png', cartoon)
        return cartoon